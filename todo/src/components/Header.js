...
function Header() {
  return (
    <div className='row' style={{ padding: '10px 30px', backgroundColor:'rgb(222, 67, 82)', height: '6.5vh'}}>
      <div className='col-10'>
        <div className='row'>
          ...
          <div className='col-11' style={{position: 'relative'}}>
            <span style={{position: 'absolute', padding: '2px 5px', display:'inline-block'}}>
            ...
            <input type="text" placeholder="Search" aria-label=".form-control-lg example" style={{backgroundColor:'rgba(256,256,256,0.1)', color:'white', border: "none", height:'30px', paddingLeft: '30px'}}/>
          </div>
        </div>
      </div>
      <div className='col-2'>
        <div className='row'>
          <div className='col' style={{cursor: 'pointer'}} data-bs-toggle="modal" data-bs-target="#exampleModal">
          ...
          <div className='col'>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" className="bi bi-question-circle" viewBox="0 0 16 16">
